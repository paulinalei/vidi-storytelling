var stories = [
    {
        'text': 'Marine biodiversity is threatened by climate change and increasing human-related stressors'
    },
    {
        'text': 'Periodic changes of sea surface temperature -- El Nino and La Nina -- in the Pacific Ocean have impacts all over the globe. How is biodiversity affected by climate change?', 
    ...
    {
        'text': 'We will be exploring the relationship between species and climate change.',
    ...
    {
        'text': 'This is our visualization of species in a specific latitude and longitude range of the ocean in the San Francisco Bay Area.'
    },
    {
        'text': 'Here we see in [insert year] the corresponding sea surface temperatures and diversity of marine populations.'
    },
    {
        'text': 'In 2015, we saw an increase in biodiversity with warmer sea surface temperatures.'
    }
]